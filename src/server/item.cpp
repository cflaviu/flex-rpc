...
{
    error_t item::handle_request(const message::request::item& request, const context_id context)
    {
        error_t result;
    ...
    void item::handle_requests(const message::request::array& requests, const context_id context) noexcept
    {
        for (auto& item: requests)
        {
            try
            {
                handle_request(item, context);
            }
    ...
    error_t item::on_call_cancel_request(const context_id context, const message::call::cancel::request& request,
                                         buffer_view& output_buffer)
    {
        output_buffer = buffer_view(output_buffer.data(), 0);
        return error_t::none;
    }

    error_t item::on_call_request(const context_id context, const message::call::request& request, buffer_view& output_buffer)
    {
        return not_implemented<message::call::response>(context, output_buffer);
    }

    error_t item::on_connection_request(const context_id context, const message::connection::request& request, buffer_view& output_buffer)
    {
        return not_implemented<message::connection::response>(context, output_buffer);
    }

    error_t item::on_disconnection_request(const context_id context, const message::disconnection::request& /*request*/,
                                           buffer_view& /*output_buffer*/)
    {
        return error_t::none;
    }

    error_t item::on_discovery_event_request(const context_id context, const message::discovery::event::request& request,
                                             buffer_view& output_buffer)
    {
        return not_implemented<message::discovery::event::response>(context, output_buffer);
    }

    error_t item::on_discovery_method_request(const context_id context, const message::discovery::method::request& request,
                                              buffer_view& output_buffer)
    {
        return not_implemented<message::discovery::method::response>(context, output_buffer);
    }

    error_t item::on_discovery_object_request(const context_id context, const message::discovery::object::request& request,
                                              buffer_view& output_buffer)
    {
        return not_implemented<message::discovery::object::response>(context, output_buffer);
    }

    error_t item::on_dlt_activate_request(const context_id context, const message::dlt::activate::request& request,
                                          buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::activate::response>(context, output_buffer);
    }

    error_t item::on_dlt_clear_request(const context_id context, const message::dlt::clear::request& request, buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::activate::response>(context, output_buffer);
    }

    error_t item::on_dlt_configuration_change_request(const context_id context, const message::dlt::configuration::change::request& request,
                                                      buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::activate::response>(context, output_buffer);
    }

    error_t item::on_dlt_configuration_reset_request(const context_id context, const message::dlt::configuration::reset::request& request,
                                                     buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::configuration::reset::response>(context, output_buffer);
    }

    error_t item::on_dlt_configuration_retrieve_request(const context_id context,
    ...
    error_t item::on_dlt_deactivate_request(const context_id context, const message::dlt::deactivate::request& request,
                                            buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::deactivate::response>(context, output_buffer);
    }

    error_t item::on_dlt_status_request(const context_id context, const message::dlt::status::request& request, buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::status::response>(context, output_buffer);
    }

    error_t item::on_dlt_retrieve_request(const context_id context, const message::dlt::retrieve::request& request,
                                          buffer_view& output_buffer)
    {
        return not_implemented<message::dlt::retrieve::response>(context, output_buffer);
    }

    error_t item::on_event_generator_create_request(const context_id context, const message::event::generator::create::request& request,
                                                    buffer_view& output_buffer)
    {
        return not_implemented<message::event::generator::create::response>(context, output_buffer);
    }

    error_t item::on_event_generator_destroy_request(const context_id context, const message::event::generator::destroy::request& request,
                                                     buffer_view& output_buffer)
    {
        return not_implemented<message::event::generator::destroy::response>(context, output_buffer);
    }

    error_t item::on_event_subscription_request(const context_id context, const message::event::subscription::request& request,
                                                buffer_view& output_buffer)
    {
        return not_implemented<message::event::subscription::response>(context, output_buffer);
    }

    error_t item::on_event_unsubscription_request(const context_id context, const message::event::unsubscription::request& request,
                                                  buffer_view& output_buffer)
    {
        return not_implemented<message::event::unsubscription::response>(context, output_buffer);
    }

    error_t item::on_feature_list_request(const context_id context, const message::feature::list::request& request,
                                          buffer_view& output_buffer)
    {
        return not_implemented<message::feature::list::response>(context, output_buffer);
    }

    error_t item::on_ping_request(const context_id context, const message::ping::request& request, buffer_view& output_buffer)
    {
